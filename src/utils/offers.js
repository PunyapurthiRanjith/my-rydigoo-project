...
export const OFFERS = [
  {
    ...
    description: "₹100 off on your first ride within city limits.",
    discountType: "flat",
    discountValue: 100,
    maxDiscount: 100,
    minFare: 80,
  ...
  },
  {
    ...
    code: "FLAT50",
    title: "Flat ₹50 Off",
    description: "₹50 off on medium trips from 5–30 km.",
    discountType: "flat",
    discountValue: 50,
    maxDiscount: 50,
    minFare: 120,
  ...
  },
  {
    ...
    code: "AUTO25",
    title: "Auto Saver",
    description: "₹25 off on auto rides between 2–20 km.",
    discountType: "flat",
    discountValue: 25,
    maxDiscount: 25,
    minFare: 60,
  ...
  },
  {
    ...
    description: "₹100 off on car rides above 8 km (max 50 km).",
    discountType: "flat",
    discountValue: 100,
    maxDiscount: 100,
    minFare: 200,
